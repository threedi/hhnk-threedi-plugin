...
# Creates items to be in widget
    ...
    model_state_widget.model_selector = QLabel("log in:"
    ...
    model_state_widget.log_in_txt = QLineEdit()
    ...
    # model_state_widget.login_label = QLabel('3di User Na')
    ...
    # model_state_widget.one_d_two_d_group = QGroupBox(title="HHNK 3di Tool Log in")
    # model_state_widget.one_d_two_d_group.setEnabled(True)
    ...
    # model_state_widget.datachecker_selector = widgets.Text(
    ...
    log_in_layout.addWidget(model_state_widget.log_in_txt)
