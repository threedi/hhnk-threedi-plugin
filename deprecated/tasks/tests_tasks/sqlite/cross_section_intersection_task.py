...
from hhnk_threedi_plugin.gui.tests.sqlite_test_widgets.profiles_used_result import (
...
class crossSectionIntersectionTask(QgsTask):
    ...
    def __init__(self, test_env, mutex, wait_cond):
        ...
        self.layers_list = [
            self.test_env.layers["profiel_geen_snijpunt_vertex_vars"],
        ]
    ...
    def run(self):
        ...
        try:
            if self.os_retry is None:
                ...
                self.gdf = sqlite_test.run_cross_secction_vertex()
