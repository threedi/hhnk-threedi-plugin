...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
    ...
    <symbols>
      <symbol type="marker" name="0" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer enabled="1" class="SvgMarker" locked="0" pass="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="0,29,255,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="//srv57d1/geo_info/02_Werkplaatsen/06_HYD/Projecten/HKC16015 Wateropgave 2.0/00.Media/op_onderbemaling.svg"/>
          <prop k="offset" v="0,0"/>
  ...
  <aliases>
    ...
    <alias field="op_poldergrens" name="" index="3"/>
    <alias field="moet_op_peilgrens" name="" index="4"/>
    <alias field="opmerkingen" name="" index="5"/>
  </aliases>
  <defaults>
