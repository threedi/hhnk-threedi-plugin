...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>v2_manhole_view</se:Name>
    <UserStyle>
      <se:Name>v2_manhole_view</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Manhole (inspection)</se:Name>
          <se:Description>
            <se:Title>Manhole (inspection)</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>manh_manhole_indicator</ogc:PropertyName>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>square</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#3f80c0</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          <se:Name>Pumping station</se:Name>
          <se:Description>
            <se:Title>Pumping station</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>manh_manhole_indicator</ogc:PropertyName>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Stroke>
                  <se:SvgParameter name="stroke">#000000</se:SvgParameter>
                  <se:SvgParameter name="stroke-opacity">0.72</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>Manhole (unspecified)</se:Name>
          <se:Description>
            <se:Title>Manhole (unspecified)</se:Title>
          </se:Description>
          <!--Parser Error: 
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Stroke>
                  <se:SvgParameter name="stroke">#ff0901</se:SvgParameter>
