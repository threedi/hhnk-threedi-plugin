...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <labeling type="rule-based">
    <rules key="{864a00fb-e7e1-4baf-9e75-462cad617be4}">
      <rule key="{15e14ee5-8cd1-48b6-a767-b95808c6f5d1}" description="Streefpeil" scalemaxdenom="50000">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="CREATED_DA">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="WINTERPEIL">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="PEIL_Opm">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="PEIL_Bron">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="PEIL_Datum">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias field="OBJECTID_1" name="" index="1"/>
    <alias field="CODE" name="" index="2"/>
    <alias field="NAAM" name="" index="3"/>
    <alias field="OPMERKING" name="" index="4"/>
    <alias field="WS_BRON" name="" index="5"/>
    <alias field="CREATED_DA" name="" index="6"/>
    <alias field="ZOMERPEIL" name="" index="7"/>
    <alias field="WINTERPEIL" name="" index="8"/>
    <alias field="PEIL_Opm" name="" index="9"/>
    <alias field="PEIL_Bron" name="" index="10"/>
    <alias field="PEIL_Datum" name="" index="11"/>
    <alias field="SHAPE_Length" name="" index="12"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="CREATED_DA" expression=""/>
    <default applyOnUpdate="0" field="ZOMERPEIL" expression=""/>
    <default applyOnUpdate="0" field="WINTERPEIL" expression=""/>
    <default applyOnUpdate="0" field="PEIL_Opm" expression=""/>
    <default applyOnUpdate="0" field="PEIL_Bron" expression=""/>
    <default applyOnUpdate="0" field="PEIL_Datum" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="OBJECTID_1" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" constraints="0" field="CREATED_DA" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="ZOMERPEIL" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="WINTERPEIL" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="PEIL_Opm" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="PEIL_Bron" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="PEIL_Datum" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="OBJECTID_1" exp="" desc=""/>
    <constraint field="CODE" exp="" desc=""/>
    <constraint field="NAAM" exp="" desc=""/>
    <constraint field="OPMERKING" exp="" desc=""/>
    <constraint field="WS_BRON" exp="" desc=""/>
    <constraint field="CREATED_DA" exp="" desc=""/>
    <constraint field="ZOMERPEIL" exp="" desc=""/>
    <constraint field="WINTERPEIL" exp="" desc=""/>
    <constraint field="PEIL_Opm" exp="" desc=""/>
    <constraint field="PEIL_Bron" exp="" desc=""/>
    <constraint field="PEIL_Datum" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="OBJECTID_1" width="-1" hidden="0"/>
      <column type="field" name="CREATED_DA" width="-1" hidden="0"/>
      <column type="field" name="ZOMERPEIL" width="-1" hidden="0"/>
      <column type="field" name="WINTERPEIL" width="-1" hidden="0"/>
      <column type="field" name="PEIL_Opm" width="-1" hidden="0"/>
      <column type="field" name="PEIL_Bron" width="-1" hidden="0"/>
      <column type="field" name="PEIL_Datum" width="-1" hidden="0"/>
    </columns>
