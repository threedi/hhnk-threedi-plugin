...
<qgis maxScale="inf" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMin="0" type="singlebandpseudocolor" alphaBand="-1" opacity="1" nodataColor="" classificationMax="0.12" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" labelPrecision="6" minimumValue="0" classificationMode="1" maximumValue="0.12">
          <item color="#fafafa" label="0" alpha="255" value="0"/>
          <item color="#dfdfdf" label="0.0133" alpha="255" value="0.0133"/>
          <item color="#c4c4c4" label="0.0267" alpha="255" value="0.0267"/>
          <item color="#a8a8a8" label="0.04" alpha="255" value="0.04"/>
          <item color="#8d8d8d" label="0.0533" alpha="255" value="0.0533"/>
          <item color="#727272" label="0.0667" alpha="255" value="0.0667"/>
          <item color="#575757" label="0.08" alpha="255" value="0.08"/>
          <item color="#3b3b3b" label="0.0933" alpha="255" value="0.0933"/>
          <item color="#202020" label="0.107" alpha="255" value="0.107"/>
          <item color="#050505" label="0.12" alpha="255" value="0.12"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
  ...
  <originalStyle>
    <maplayer maxScale="inf" refreshOnNotifyEnabled="0" type="raster" hasScaleBasedVisibilityFlag="0" autoRefreshEnabled="0" autoRefreshTime="0" minScale="1e+08" styleCategories="AllStyleCategories" refreshOnNotifyMessage="">
      <id>storage_ggg_Marken20190520161435906</id>
      <datasource>../02. Sqlite modeldatabase/rasters/storage_ggg_waterland.tif</datasource>
      <keywordList>
        <value/>
      </keywordList>
      <layername>storage_ggg</layername>
      <srs>
        <spatialrefsys>
      ...
      <pipe>
        <rasterrenderer classificationMin="0" alphaBand="-1" type="singlebandpseudocolor" opacity="1" classificationMax="0.12" band="1">
          <rasterTransparency/>
          <minMaxOrigin>
            <limits>MinMax</limits>
            <extent>WholeRaster</extent>
