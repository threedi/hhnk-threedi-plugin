...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
    ...
    <symbols>
      <symbol type="fill" name="0" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer enabled="1" class="LinePatternFill" locked="0" pass="0">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="lineDistance">
                  ...
                  <Option type="QString" name="expression" value="0.7 + (refinement_level-1) * 0.5"/>
          ...
          <symbol type="line" name="@0@0" clip_to_extent="1" force_rhr="0" alpha="1">
            <layer enabled="1" class="SimpleLine" locked="0" pass="0">
              ...
              <prop k="line_color" v="121,191,130,255"/>
        ...
        <layer enabled="1" class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="17,94,46,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.46"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" isExpression="0" fontStrikeout="0" fontSize="8" textOrientation="horizontal" fontSizeUnit="Point" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" namedStyle="Regular" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="0,0,0,255" allowHtml="0" capitalization="0" fontItalic="0" blendMode="0" fontWeight="50" textOpacity="1" useSubstitutions="0" fieldName="code" fontUnderline="0" fontKerning="1" fontFamily="MS Gothic" fontWordSpacing="0">
        <text-buffer bufferBlendMode="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferDraw="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.7" bufferNoFill="1"/>
      ...
      <placement xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" layerType="PolygonGeometry" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistance="0" geometryGeneratorType="PointGeometry" distUnits="MM" rotationAngle="0" repeatDistanceUnits="MM" geometryGenerator="" dist="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" centroidInside="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" geometryGeneratorEnabled="0" offsetUnits="MM" polygonPlacementFlags="2" placement="2" lineAnchorPercent="0.5" offsetType="0" repeatDistance="0" yOffset="0" quadOffset="4"/>
      <rendering displayAll="0" obstacleType="0" zIndex="0" labelPerPart="0" fontLimitPixelSize="0" minFeatureSize="0" fontMinPixelSize="3" fontMaxPixelSize="10000" obstacle="1" upsidedownLabels="0" scaleMax="0" obstacleFactor="1" drawLabels="1" maxNumLabels="2000" limitNumLabels="0" mergeLines="0" scaleMin="0" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="refinement_level">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="refinement_level" expression="1"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="1" field="refinement_level" exp_strength="0" notnull_strength="2"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="refinement_level" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="General" groupBox="0" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
      ...
      <attributeEditorField name="refinement_level" showLabel="1" index="2"/>
