...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>bodemhoogte_kunstwerken</se:Name>
    <UserStyle>
      <se:Name>bodemhoogte_kunstwerken</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
        ...
        <se:Rule>
          ...
          <se:MaxScaleDenominator>40855</se:MaxScaleDenominator>
          <se:TextSymbolizer>
            <se:Label>
              <!--SE Export for 'code: ' || struct_code || '\n' || 'Structure reference level: ' || structure_reference_level || '\n' || 'Cross section reference level: ' || cross_reference_level || '\n' || 'Distance: ' || dist_cross_to_structure not implemented yet-->Placeholder</se:Label>
            <se:Font>
