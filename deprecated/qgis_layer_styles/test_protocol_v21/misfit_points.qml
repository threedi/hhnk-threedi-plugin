...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field configurationFlags="None" name="tabel">
  ...
  <aliases>
    <alias field="tabel" name="" index="0"/>
    <alias field="code" name="" index="1"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="tabel" expression=""/>
    <default applyOnUpdate="0" field="code" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="tabel" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="code" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="tabel" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column type="field" name="tabel" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>"tabel"</previewExpression>
  <mapTip></mapTip>
