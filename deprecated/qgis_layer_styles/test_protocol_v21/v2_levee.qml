...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <renderer-v2 type="categorizedSymbol" forceraster="0" attr="material" enableorderby="0" symbollevels="0">
    <categories>
      <category symbol="0" label="1: sand" render="true" value="1"/>
      <category symbol="1" label="2: clay" render="true" value="2"/>
      <category symbol="2" label="NULL or other" render="true" value=""/>
    </categories>
    <symbols>
      <symbol type="line" name="0" clip_to_extent="1" force_rhr="0" alpha="1">
        ...
        <layer enabled="1" class="HashLine" locked="0" pass="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="max_breach_depth">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="max_breach_depth" exp_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="max_breach_depth" width="-1" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="General" groupBox="0" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
      ...
      <attributeEditorField name="code" showLabel="1" index="0"/>
      <attributeEditorField name="crest_level" showLabel="1" index="2"/>
      <attributeEditorField name="material" showLabel="1" index="1"/>
      <attributeEditorField name="max_breach_depth" showLabel="1" index="3"/>
