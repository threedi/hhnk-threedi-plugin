...
# from hhnk_threedi_plugin.gui.log_in_btn import LogInDialog
...
class HHNK_toolbox:
    ...
    # def model_splitter_execute(self):
    #     dialog = modelSplitterDialog()
    #     # dialog.project_folder_path.connect(Folders)
    #     dialog.exec()
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.model_states_dialog = modelStateDialog(self, parent=self.dockwidget)
                self.model_splitter_dialog = modelSplitterDialog(self, parent=self.dockwidget)
                ...
                # self.dockwidget.input_btn.clicked.connect(self.input_data)
                ...
                # self.model_states_dialog.connect(self.get_api)
