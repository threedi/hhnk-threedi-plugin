...
@REM SET PLUGIN_PATH=%appdata%\3Di\QGIS3\profiles\default\python\plugins
SET PLUGIN_PATH=C:\Users\wvanesse\AppData\Roaming\3Di\QGIS3\profiles\default\python\plugins
