...
#%%
uicls, basecls = uic.loadUiType(os.path.join(base_dir,"model_states", "model_splitter_dialog.ui"))
...
class LogInDialog(uicls, basecls):
    ...
    def log_in_threedi(self):
        ...
        username = self.username.text(self)
        ...
        self.model_splitter_dialog.pb__log_in.clicked.connect(self.log_in_threedi)
# #%%