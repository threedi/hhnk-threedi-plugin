...
from ....gui.tests.sqlite_tests.result_widgets.isolated_channels_result import (
...
class isolatedChannelsTask(QgsTask):
    ...
    def __init__(self, test_env, mutex, wait_cond):
        ...
        self.layers_list = [test_env.layers["isolated_channels_layer_vars"]]
    ...
    def run(self):
        ...
        try:
            ...
            hrt.gdf_write_to_csv(
                ...
                filename=self.test_env.output_vars["isolated_channels_filename"],
            )
