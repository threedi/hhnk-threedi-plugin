...
from hhnk_threedi_plugin.qgis_interaction.project import (  # TODO dependencies snappen waarom die een melding geeft
    Layer,
    Project,
)
...
self.grid = hrt.threedi.grid.Grid(
    sqlite_path=self.fenv.model.schema_base.sqlite_paths[0], dem_path=self.fenv.model.schema_base.rasters.dem.path
)
...
def build_vrt(raster_folder, vrt_name="combined_rasters", bandlist=[1], bounds=None, overwrite=False):
    ...
    tifs_list = [
        os.path.join(raster_folder, i) for i in os.listdir(raster_folder) if i.endswith(".tif") or i.endswith(".tiff")
    ]
...
build_vrt(
    raster_folder=r"\\srv57d1\geo_info\02_Werkplaatsen\06_HYD\Projecten\HKC16015 Wateropgave 2.0\06. Afgeleide gegevens\01.Input\inundatie_ref_T10_corr3"
)
build_vrt(
    raster_folder=r"\\srv57d1\geo_info\02_Werkplaatsen\06_HYD\Projecten\HKC16015 Wateropgave 2.0\06. Afgeleide gegevens\01.Input\inundatie_ref_T100_corr3"
)
build_vrt(
    raster_folder=r"\\srv57d1\geo_info\02_Werkplaatsen\06_HYD\Projecten\HKC16015 Wateropgave 2.0\06. Afgeleide gegevens\01.Input\inundatie_ref_T1000_corr3"
)
...
q_p = [
    "E:\\github\\wvangerwen\\hhnk-threedi-tools",
    "E:\\github\\wvangerwen\\hhnk-threedi-tools",
    ...
    "C:\\Users\\wvangerwen\\AppData\\Roaming\\3Di\\QGIS3\\profiles\\default/python/plugins",
