...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <aliases>
    ...
    <alias field="calculation_type" name="" index="3"/>
    <alias field="dist_calc_points" name="" index="4"/>
    <alias field="zoom_category" name="" index="5"/>
    <alias field="connection_node_start_id" name="" index="6"/>
    <alias field="connection_node_end_id" name="" index="7"/>
  </aliases>
  <defaults>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="Channel" groupBox="0" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
