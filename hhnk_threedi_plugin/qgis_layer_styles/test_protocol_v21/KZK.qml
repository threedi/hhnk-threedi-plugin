...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="levee_ring_id">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias field="levee_ring_id" name="" index="2"/>
    <alias field="channel_type_id" name="" index="3"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="OBJECTID" expression=""/>
    <default applyOnUpdate="0" field="channel_id" expression=""/>
    <default applyOnUpdate="0" field="levee_ring_id" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="levee_ring_id" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="levee_ring_id" exp="" desc=""/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>"channel_id"</previewExpression>
  <mapTip></mapTip>
