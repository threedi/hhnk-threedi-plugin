...
<qgis maxScale="inf" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMin="-5" type="singlebandpseudocolor" alphaBand="-1" opacity="1" nodataColor="" classificationMax="5" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" labelPrecision="6" minimumValue="-5" classificationMode="1" maximumValue="5">
          <item color="#050603" label="-5" alpha="255" value="-5"/>
          <item color="#373724" label="-4" alpha="255" value="-4"/>
          <item color="#183e29" label="-3" alpha="255" value="-3"/>
          <item color="#346945" label="-2" alpha="255" value="-2"/>
          <item color="#3e8a59" label="-1" alpha="255" value="-1"/>
          <item color="#6ca363" label="0" alpha="255" value="0"/>
          <item color="#a5ba6f" label="1" alpha="255" value="1"/>
          <item color="#e7d57a" label="2" alpha="255" value="2"/>
          <item color="#c7a75c" label="3" alpha="255" value="3"/>
          <item color="#b0783a" label="4" alpha="255" value="4"/>
          <item color="#d77f3f" label="5" alpha="255" value="5"/>
          <item color="#103f5f" label="10" alpha="255" value="10"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
  ...
  <originalStyle>
    <maplayer maxScale="inf" refreshOnNotifyEnabled="0" type="raster" hasScaleBasedVisibilityFlag="0" autoRefreshEnabled="0" autoRefreshTime="0" minScale="1e+08" styleCategories="AllStyleCategories" refreshOnNotifyMessage="">
      ...
      <pipe>
        <rasterrenderer classificationMin="-5" alphaBand="-1" type="singlebandpseudocolor" opacity="1" classificationMax="5" band="1">
          <rasterTransparency/>
          <minMaxOrigin>
            <limits>None</limits>
            <extent>WholeRaster</extent>
