...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
        ...
        <layer enabled="1" class="MarkerLine" locked="0" pass="0">
          ...
          <symbol type="marker" name="@0@0" clip_to_extent="1" force_rhr="0" alpha="1">
            <layer enabled="1" class="SvgMarker" locked="0" pass="0">
              ...
              <prop k="name" v="//srv57d1/geo_info/02_Werkplaatsen/06_HYD/Projecten/HKC16015 Wateropgave 2.0/00.Media/duiker.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Categorie">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="modelleren_als">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias field="Categorie" name="" index="2"/>
    <alias field="modelleren_als" name="" index="3"/>
    <alias field="opmerkingen" name="" index="4"/>
    <alias field="SHAPE_Length" name="" index="5"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="modelleren_als" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="Categorie" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="modelleren_als" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="Categorie" exp="" desc=""/>
    <constraint field="modelleren_als" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="Categorie" width="-1" hidden="0"/>
      <column type="field" name="modelleren_als" width="-1" hidden="0"/>
