...
<qgis maxScale="0" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="external">
      <editWidget type="CheckBox">
        <config>
          <Option type="Map">
            <Option type="QString" name="CheckedState" value="1"/>
  ...
  <aliases>
    ...
    <alias field="cross_section_definition_id" name="" index="9"/>
    <alias field="external" name="" index="10"/>
    <alias field="crest_type" name="" index="11"/>
    <alias field="friction_type" name="" index="12"/>
    <alias field="friction_value" name="" index="13"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="external" exp_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="external" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="Weir" groupBox="0" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
      ...
      <attributeEditorContainer columnCount="1" name="Characteristics" groupBox="1" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
        <attributeEditorField name="crest_level" showLabel="1" index="7"/>
        <attributeEditorField name="crest_type" showLabel="1" index="11"/>
        ...
        <attributeEditorField name="friction_value" showLabel="1" index="13"/>
        <attributeEditorField name="friction_type" showLabel="1" index="12"/>
        <attributeEditorField name="cross_section_definition_id" showLabel="1" index="9"/>
      </attributeEditorContainer>
      <attributeEditorContainer columnCount="1" name="Visualization" groupBox="1" showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="">
        ...
        <attributeEditorField name="external" showLabel="1" index="10"/>
      </attributeEditorContainer>
