...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="PRO_ID">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="PROIDENT">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="OVK_OVK_ID">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="PRW_PRW_ID">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="OPRDATOP">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="OSMOMSCH">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="Betrouwbaar">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias field="PRO_ID" name="" index="1"/>
    <alias field="PROIDENT" name="" index="2"/>
    <alias field="OVK_OVK_ID" name="" index="3"/>
    <alias field="PRW_PRW_ID" name="" index="4"/>
    <alias field="OPRDATOP" name="" index="5"/>
    <alias field="OSMOMSCH" name="" index="6"/>
    <alias field="Betrouwbaar" name="" index="7"/>
    <alias field="SHAPE_Length" name="" index="8"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="OBJECTID" expression=""/>
    <default applyOnUpdate="0" field="PRO_ID" expression=""/>
    <default applyOnUpdate="0" field="PROIDENT" expression=""/>
    <default applyOnUpdate="0" field="OVK_OVK_ID" expression=""/>
    <default applyOnUpdate="0" field="PRW_PRW_ID" expression=""/>
    <default applyOnUpdate="0" field="OPRDATOP" expression=""/>
    <default applyOnUpdate="0" field="OSMOMSCH" expression=""/>
    <default applyOnUpdate="0" field="Betrouwbaar" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="PRO_ID" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="PROIDENT" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="OVK_OVK_ID" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="PRW_PRW_ID" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="OPRDATOP" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="OSMOMSCH" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="Betrouwbaar" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="PRO_ID" exp="" desc=""/>
    <constraint field="PROIDENT" exp="" desc=""/>
    <constraint field="OVK_OVK_ID" exp="" desc=""/>
    <constraint field="PRW_PRW_ID" exp="" desc=""/>
    <constraint field="OPRDATOP" exp="" desc=""/>
    <constraint field="OSMOMSCH" exp="" desc=""/>
    <constraint field="Betrouwbaar" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="PRO_ID" width="-1" hidden="0"/>
      <column type="field" name="PROIDENT" width="-1" hidden="0"/>
      <column type="field" name="OVK_OVK_ID" width="-1" hidden="0"/>
      <column type="field" name="PRW_PRW_ID" width="-1" hidden="0"/>
      <column type="field" name="OSMOMSCH" width="-1" hidden="0"/>
