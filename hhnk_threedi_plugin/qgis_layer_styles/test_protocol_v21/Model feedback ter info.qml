...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="table_name">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field configurationFlags="None" name="message">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias field="level" name="" index="1"/>
    <alias field="feature_id" name="" index="2"/>
    <alias field="table_name" name="" index="3"/>
    <alias field="message" name="" index="4"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="id" expression=""/>
    <default applyOnUpdate="0" field="level" expression=""/>
    <default applyOnUpdate="0" field="feature_id" expression=""/>
    <default applyOnUpdate="0" field="table_name" expression=""/>
    <default applyOnUpdate="0" field="message" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" constraints="0" field="id" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="level" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="feature_id" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="table_name" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="message" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" exp="" desc=""/>
    <constraint field="level" exp="" desc=""/>
    <constraint field="feature_id" exp="" desc=""/>
    <constraint field="table_name" exp="" desc=""/>
    <constraint field="message" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;level&quot;" sortOrder="0">
    <columns>
      ...
      <column type="field" name="table_name" width="-1" hidden="0"/>
      <column type="field" name="message" width="449" hidden="0"/>
