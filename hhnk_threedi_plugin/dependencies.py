...
FLEXIBLE_DEPENDENCIES = [
    ...
    Dependency("hhnk_threedi_tools","hhnk_threedi_tools","0.9.1", "==0.9.1", True, "external-dependencies" , True),
    Dependency("hhnk_research_tools","hhnk_research_tools","0.7", "==0.7", True, "external-dependencies" , True), 
