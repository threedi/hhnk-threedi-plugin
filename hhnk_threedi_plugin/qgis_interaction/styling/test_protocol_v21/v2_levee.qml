...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" attr="material" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category symbol="0" render="true" label="1: sand" value="1"/>
      <category symbol="1" render="true" label="2: clay" value="2"/>
      <category symbol="2" render="true" label="NULL or other" value=""/>
    </categories>
    <symbols>
  ...
  <fieldConfiguration>
    ...
    <field name="max_breach_depth" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
  ...
  <aliases>
    <alias name="" index="0" field="code"/>
    <alias name="" index="1" field="material"/>
    <alias name="" index="2" field="crest_level"/>
    <alias name="" index="3" field="max_breach_depth"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="max_breach_depth"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="max_breach_depth"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="max_breach_depth" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="max_breach_depth" editable="1"/>
  </editable>
  <labelOnTop>
