...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="tabel" configurationFlags="None">
  ...
  <aliases>
    <alias name="" index="0" field="tabel"/>
    <alias name="" index="1" field="code"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="tabel"/>
    <default expression="" applyOnUpdate="0" field="code"/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="tabel"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="code"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="tabel"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" type="field" name="tabel" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>COALESCE( "tabel", '&lt;NULL>' )</previewExpression>
  <mapTip></mapTip>
