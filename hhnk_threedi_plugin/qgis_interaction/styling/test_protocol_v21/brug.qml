...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{47b6312f-ceb4-4432-9aaf-3a444388fb29}">
      <rule symbol="0" key="{bc1d6065-a091-4673-9463-5646a848dda0}" label="Primair" filter="&quot;WS_CATEGORIE&quot; = 1"/>
      <rule symbol="1" scalemaxdenom="25001" key="{be5d271b-8076-4fdd-8338-5ea4d1b571e7}" scalemindenom="1" label="Secundair" filter="&quot;WS_CATEGORIE&quot; in (2,3)"/>
    </rules>
    <symbols>
      <symbol type="marker" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SvgMarker" locked="0">
          ...
          <prop v="//srv57d1/geo_info/02_Werkplaatsen/06_HYD/Projecten/HKC16015 Wateropgave 2.0/00.Media/brug.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="HOOGTEONDERZIJDE"/>
    <alias name="" index="3" field="WS_CATEGORIE"/>
    <alias name="" index="4" field="Brug_ID"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="OBJECTID"/>
    <default expression="" applyOnUpdate="0" field="CODE"/>
    <default expression="" applyOnUpdate="0" field="HOOGTEONDERZIJDE"/>
    <default expression="" applyOnUpdate="0" field="WS_CATEGORIE"/>
    <default expression="" applyOnUpdate="0" field="Brug_ID"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="HOOGTEONDERZIJDE"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="WS_CATEGORIE"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="Brug_ID"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="OBJECTID"/>
    <constraint desc="" exp="" field="CODE"/>
    <constraint desc="" exp="" field="HOOGTEONDERZIJDE"/>
    <constraint desc="" exp="" field="WS_CATEGORIE"/>
    <constraint desc="" exp="" field="Brug_ID"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="HOOGTEONDERZIJDE" hidden="0"/>
      <column width="-1" type="field" name="WS_CATEGORIE" hidden="0"/>
      <column width="-1" type="field" name="Brug_ID" hidden="0"/>
