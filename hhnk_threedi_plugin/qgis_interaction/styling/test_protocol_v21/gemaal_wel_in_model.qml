...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <fieldConfiguration>
    ...
    <field name="start_point_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="end_point_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="connection_serial" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="stop_level" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="start_level_delivery_side" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="stop_level_delivery_side" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="from_fdla_code" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="to_fdla_code" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="code_polder" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="start_point_id" hidden="0"/>
      <column width="-1" type="field" name="end_point_id" hidden="0"/>
      <column width="-1" type="field" name="connection_serial" hidden="0"/>
      <column width="-1" type="field" name="capacity" hidden="0"/>
      <column width="-1" type="field" name="start_level" hidden="0"/>
      <column width="-1" type="field" name="stop_level" hidden="0"/>
      <column width="-1" type="field" name="name" hidden="0"/>
      <column width="-1" type="field" name="allowed_flow_direction" hidden="0"/>
      <column width="-1" type="field" name="start_level_delivery_side" hidden="0"/>
      <column width="-1" type="field" name="stop_level_delivery_side" hidden="0"/>
      <column width="-1" type="field" name="image_url" hidden="0"/>
      <column width="-1" type="field" name="from_fdla_code" hidden="0"/>
      <column width="-1" type="field" name="to_fdla_code" hidden="0"/>
      <column width="-1" type="field" name="channel_code" hidden="0"/>
      <column width="-1" type="field" name="code_polder" hidden="0"/>
