...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.16.11-Hannover" maxScale="inf">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" alphaBand="0" nodataColor="" opacity="1" type="singlebandpseudocolor" classificationMax="299.7" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="299.7" classificationMode="1" clip="0" colorRampType="INTERPOLATED" labelPrecision="6" minimumValue="0">
          <item alpha="255" color="#fafafa" label="0" value="0"/>
          <item alpha="255" color="#dfdfdf" label="33.3" value="33.3"/>
          <item alpha="255" color="#c4c4c4" label="66.6" value="66.6"/>
          <item alpha="255" color="#a8a8a8" label="99.9" value="99.9"/>
          <item alpha="255" color="#8d8d8d" label="133" value="133"/>
          <item alpha="255" color="#727272" label="166" value="166"/>
          <item alpha="255" color="#575757" label="200" value="200"/>
          <item alpha="255" color="#3b3b3b" label="233" value="233"/>
          <item alpha="255" color="#202020" label="266" value="266"/>
          <item alpha="255" color="#050505" label="300" value="300"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
  ...
  <originalStyle>
    <maplayer autoRefreshEnabled="0" styleCategories="AllStyleCategories" refreshOnNotifyEnabled="0" type="raster" minScale="1e+08" hasScaleBasedVisibilityFlag="0" autoRefreshTime="0" refreshOnNotifyMessage="" maxScale="inf">
      ...
      <pipe>
        <rasterrenderer band="1" alphaBand="0" opacity="1" type="singlebandpseudocolor" classificationMax="299.7" classificationMin="0">
          <rasterTransparency/>
          <minMaxOrigin>
            <limits>CumulativeCut</limits>
            <extent>WholeRaster</extent>
