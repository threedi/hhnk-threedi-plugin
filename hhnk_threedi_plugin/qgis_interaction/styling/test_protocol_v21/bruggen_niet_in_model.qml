...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <aliases>
    ...
    <alias name="" index="6" field="type"/>
    <alias name="" index="7" field="width"/>
    <alias name="" index="8" field="length"/>
    <alias name="" index="9" field="bottom_level"/>
    <alias name="" index="10" field="image_url"/>
    <alias name="" index="11" field="end"/>
    <alias name="" index="12" field="start"/>
    <alias name="" index="13" field="number_openings"/>
    <alias name="" index="14" field="channel_type_id"/>
    <alias name="" index="15" field="opmerking"/>
    <alias name="" index="16" field="channel_code"/>
    <alias name="" index="17" field="aanname"/>
    <alias name="" index="18" field="bed_level"/>
    <alias name="" index="19" field="isusable"/>
    <alias name="" index="20" field="hasassumption"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="number_openings"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="bottom_level"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="image_url"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="end"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="start"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="number_openings"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="start"/>
    <constraint desc="" exp="" field="number_openings"/>
