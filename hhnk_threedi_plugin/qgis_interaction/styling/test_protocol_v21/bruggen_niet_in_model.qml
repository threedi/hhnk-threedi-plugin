...
<qgis hasScaleBasedVisibilityFlag="1" version="3.22.7-Białowieża" symbologyReferenceScale="-1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="0" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="2500">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{47b6312f-ceb4-4432-9aaf-3a444388fb29}">
      <rule symbol="0" filter=" &quot;channel_type_id&quot;  = 1" label="Primair" key="{bc1d6065-a091-4673-9463-5646a848dda0}"/>
      ...
      <symbol alpha="1" type="marker" name="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="offset" value="-1.20000000000000062,0"/>
          ...
          <prop k="name" v="line"/>
          <prop k="offset" v="-1.20000000000000062,0"/>
        ...
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="name" value="line"/>
            <Option type="QString" name="offset" value="1.20000000000000062,0.00000000000000002"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="255,0,0,255"/>
            <Option type="QString" name="outline_style" value="solid"/>
          ...
          <prop k="joinstyle" v="miter"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="1.20000000000000062,0.00000000000000002"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,0,0,255"/>
          <prop k="outline_style" v="solid"/>
      ...
      <symbol alpha="1" type="marker" name="1" force_rhr="0" clip_to_extent="1">
        ...
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="name" value="line"/>
            <Option type="QString" name="offset" value="-0.59999999999999998,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="255,0,0,255"/>
            <Option type="QString" name="outline_style" value="solid"/>
          ...
          <prop k="joinstyle" v="miter"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="-0.59999999999999998,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,0,0,255"/>
          <prop k="outline_style" v="solid"/>
        ...
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="name" value="line"/>
            <Option type="QString" name="offset" value="0.60000000000000009,0.00000000000000001"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="255,0,0,255"/>
            <Option type="QString" name="outline_style" value="solid"/>
          ...
          <prop k="joinstyle" v="miter"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="0.60000000000000009,0.00000000000000001"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,0,0,255"/>
          <prop k="outline_style" v="solid"/>
        ...
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="90"/>
            <Option type="QString" name="cap_style" value="square"/>
            <Option type="QString" name="color" value="51,160,44,0"/>
            <Option type="QString" name="horizontal_anchor_point" value="1"/>
            <Option type="QString" name="joinstyle" value="miter"/>
            <Option type="QString" name="name" value="square"/>
            <Option type="QString" name="offset" value="0,0"/>
  ...
  <LinearlyInterpolatedDiagramRenderer lowerValue="0" attributeLegend="1" upperWidth="50" classificationAttributeExpression="" upperHeight="50" diagramType="Histogram" lowerWidth="0" upperValue="0" lowerHeight="0">
    <DiagramCategory spacingUnit="MM" backgroundColor="#ffffff" barWidth="5" maxScaleDenominator="1e+08" scaleDependency="Area" minScaleDenominator="1000" rotationOffset="270" penAlpha="255" minimumSize="0" showAxis="0" penWidth="0" direction="1" sizeType="MM" height="15" penColor="#000000" enabled="0" lineSizeType="MM" scaleBasedVisibility="0" backgroundAlpha="255" spacing="0" diagramOrientation="Up" opacity="1" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" width="15" spacingUnitScale="3x:0,0,0,0,0,0">
  ...
  <DiagramLayerSettings placement="0" zIndex="0" showAll="1" priority="0" dist="0" linePlacementFlags="2" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
  ...
  <fieldConfiguration>
    ...
    <field name="number_openings" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias index="8" field="length" name=""/>
    <alias index="9" field="bottom_level" name=""/>
    <alias index="10" field="image_url" name=""/>
    <alias index="11" field="end" name=""/>
    <alias index="12" field="start" name=""/>
    <alias index="13" field="number_openings" name=""/>
    <alias index="14" field="channel_type_id" name=""/>
    <alias index="15" field="opmerking" name=""/>
    <alias index="16" field="channel_code" name=""/>
    <alias index="17" field="aanname" name=""/>
    <alias index="18" field="bed_level" name=""/>
    <alias index="19" field="isusable" name=""/>
    <alias index="20" field="hasassumption" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="number_openings" expression="" applyOnUpdate="0"/>
    ...
    <default field="bed_level" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="width" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="length" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="bottom_level" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint field="start" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="number_openings" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint field="bed_level" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="number_openings" desc="" exp=""/>
    ...
    <constraint field="bed_level" desc="" exp=""/>
  ...
  <attributetableconfig sortExpression="&quot;channel_type_id&quot;" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="bottom_level"/>
      <column hidden="0" width="-1" type="field" name="image_url"/>
      <column hidden="0" width="-1" type="field" name="end"/>
      <column hidden="0" width="-1" type="field" name="start"/>
      <column hidden="0" width="-1" type="field" name="number_openings"/>
      ...
      <column hidden="0" width="-1" type="field" name="bed_level"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="Aantal_doorstroomopeningen" editable="1"/>
    <field name="Brug_ID" editable="1"/>
    <field name="CODE" editable="1"/>
    <field name="DOORVAARTBREEDTE" editable="1"/>
    <field name="HOOGTEONDERZIJDE" editable="1"/>
    <field name="OBJECTID" editable="1"/>
    <field name="Som_doorstroombreedte" editable="1"/>
    <field name="WS_CATEGORIE" editable="1"/>
    <field name="aanname" editable="1"/>
    <field name="bed_level" editable="1"/>
    ...
    <field name="number_openings" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="Brug_ID" labelOnTop="0"/>
    <field name="CODE" labelOnTop="0"/>
    <field name="DOORVAARTBREEDTE" labelOnTop="0"/>
    <field name="HOOGTEONDERZIJDE" labelOnTop="0"/>
    <field name="OBJECTID" labelOnTop="0"/>
    <field name="Som_doorstroombreedte" labelOnTop="0"/>
    <field name="WS_CATEGORIE" labelOnTop="0"/>
    <field name="aanname" labelOnTop="0"/>
    <field name="bed_level" labelOnTop="0"/>
    ...
    <field name="number_openings" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="Brug_ID" reuseLastValue="0"/>
    <field name="CODE" reuseLastValue="0"/>
    <field name="DOORVAARTBREEDTE" reuseLastValue="0"/>
    <field name="HOOGTEONDERZIJDE" reuseLastValue="0"/>
    ...
    <field name="bed_level" reuseLastValue="0"/>
