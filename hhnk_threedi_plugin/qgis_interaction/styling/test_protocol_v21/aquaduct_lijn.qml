...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" minScale="25000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="1" simplifyDrawingTol="1" simplifyDrawingHints="1">
    ...
    <symbols>
      <symbol type="line" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="250,52,17,255" k="line_color"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" type="field" name="AQUADUCTID" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="AQUADUCTID" editable="1"/>
    <field name="OBJECTID" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="AQUADUCTID" labelOnTop="0"/>
    <field name="OBJECTID" labelOnTop="0"/>
  </labelOnTop>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>AQUADUCTID</previewExpression>
  <mapTip></mapTip>
