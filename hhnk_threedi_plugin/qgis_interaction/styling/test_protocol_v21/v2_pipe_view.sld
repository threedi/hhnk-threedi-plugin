...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>v2_pipe_view</se:Name>
    <UserStyle>
      <se:Name>v2_pipe_view</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Combined sewer</se:Name>
          <se:Description>
            <se:Title>Combined sewer</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Storm drain</se:Name>
          <se:Description>
            <se:Title>Storm drain</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#55aaff</se:SvgParameter>
              <se:SvgParameter name="stroke-width">1</se:SvgParameter>
              <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
              <se:SvgParameter name="stroke-linecap">square</se:SvgParameter>
            </se:Stroke>
        ...
        <se:Rule>
          <se:Name>Sanitary sewer</se:Name>
          <se:Description>
            <se:Title>Sanitary sewer</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Spillway</se:Name>
          <se:Description>
            <se:Title>Spillway</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Syphon</se:Name>
          <se:Description>
            <se:Title>Syphon</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Storage and settlement tank</se:Name>
          <se:Description>
            <se:Title>Storage and settlement tank</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>pipe_sewerage_type</ogc:PropertyName>
