...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement placementFlags="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" lineAnchorType="0" centroidInside="0" yOffset="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" layerType="PointGeometry" maxCurvedCharAngleIn="20" distUnits="MM" priority="5" lineAnchorPercent="0.5" overrunDistanceUnit="MM" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" maxCurvedCharAngleOut="-20" rotationAngle="0" geometryGenerator="" offsetUnits="MapUnit" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" xOffset="0" preserveRotation="1" overrunDistance="0" quadOffset="4" placement="0" geometryGeneratorType="PointGeometry"/>
      <rendering displayAll="0" minFeatureSize="0" labelPerPart="0" drawLabels="1" fontMaxPixelSize="10000" obstacleType="0" scaleVisibility="0" scaleMin="1" fontMinPixelSize="3" scaleMax="2000" zIndex="0" upsidedownLabels="0" fontLimitPixelSize="0" maxNumLabels="2000" mergeLines="0" obstacle="1" limitNumLabels="0" obstacleFactor="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="the_geom_linestring" configurationFlags="None">
  ...
  <constraints>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="the_geom_linestring"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1" field="code"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="initial_waterlevel"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;code&quot;" sortOrder="1">
    <columns>
      <column width="-1" type="field" name="the_geom_linestring" hidden="0"/>
