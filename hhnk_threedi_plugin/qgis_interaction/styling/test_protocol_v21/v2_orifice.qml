...
<qgis readOnly="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.16.11-Hannover" maxScale="0">
  ...
  <fieldConfiguration>
    ...
    <field name="discharge_coefficient_negative" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="discharge_coefficient_positive" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="crest_type" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="discharge_coefficient_negative"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="1" constraints="1" field="sewerage"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="connection_node_start_id"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="discharge_coefficient_positive"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="crest_level"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="max_capacity"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="crest_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="friction_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="friction_value"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="cross_section_definition_id"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="discharge_coefficient_negative"/>
    <constraint desc="" exp="" field="sewerage"/>
    <constraint desc="" exp="" field="connection_node_start_id"/>
    <constraint desc="" exp="" field="discharge_coefficient_positive"/>
    <constraint desc="" exp="" field="crest_level"/>
    <constraint desc="" exp="" field="max_capacity"/>
    <constraint desc="" exp="" field="crest_type"/>
    <constraint desc="" exp="" field="friction_type"/>
    <constraint desc="" exp="" field="friction_value"/>
    <constraint desc="" exp="" field="cross_section_definition_id"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="max_capacity" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="Orifice" visibilityExpression="" groupBox="0" showLabel="1">
      ...
      <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="Visualizations" visibilityExpression="" groupBox="1" showLabel="1">
