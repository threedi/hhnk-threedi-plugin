...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="-4.65661e-10" simplifyDrawingTol="1" simplifyDrawingHints="0">
    ...
    <symbols>
      <symbol type="marker" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SvgMarker" locked="0">
          ...
          <prop v="//srv57d1/geo_info/02_Werkplaatsen/06_HYD/Projecten/HKC16015 Wateropgave 2.0/00.Media/vaste_dam.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias name="" index="3" field="channel_code"/>
    <alias name="" index="4" field="opmerking"/>
    <alias name="" index="5" field="wgtype_id"/>
    <alias name="" index="6" field="channel_type_id"/>
    <alias name="" index="7" field="isusable"/>
  </aliases>
  <defaults>
