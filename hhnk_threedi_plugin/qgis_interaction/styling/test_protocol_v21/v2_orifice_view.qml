...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontLetterSpacing="0" fontWeight="50" useSubstitutions="0" blendMode="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" isExpression="1" fontWordSpacing="0" fontStrikeout="0" textColor="227,26,28,255" fontSize="8" textOrientation="horizontal" fontKerning="1" fontFamily="MS Shell Dlg 2" allowHtml="0" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontUnderline="0" fieldName="coalesce(round(weir_crest_level, 2), 'NULL')" fontSizeUnit="Point" textOpacity="1" namedStyle="Standaard">
        <text-buffer bufferOpacity="1" bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferNoFill="0" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.7" bufferBlendMode="0" bufferJoinStyle="128"/>
      ...
      <placement placementFlags="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" lineAnchorType="0" centroidInside="0" yOffset="0" repeatDistanceUnits="MM" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" polygonPlacementFlags="2" geometryGeneratorEnabled="1" layerType="LineGeometry" maxCurvedCharAngleIn="25" distUnits="MM" priority="5" lineAnchorPercent="0.5" overrunDistanceUnit="MM" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" maxCurvedCharAngleOut="-25" rotationAngle="0" geometryGenerator="centroid($geometry)" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" xOffset="2" preserveRotation="0" overrunDistance="0" quadOffset="2" placement="1" geometryGeneratorType="PointGeometry"/>
      <rendering displayAll="1" minFeatureSize="0" labelPerPart="0" drawLabels="1" fontMaxPixelSize="10000" obstacleType="0" scaleVisibility="1" scaleMin="1" fontMinPixelSize="3" scaleMax="2500" zIndex="0" upsidedownLabels="0" fontLimitPixelSize="0" maxNumLabels="2000" mergeLines="0" obstacle="1" limitNumLabels="0" obstacleFactor="1"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
  ...
  <fieldConfiguration>
    ...
    <field name="orf_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field name="orf_display_name" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_code" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_max_capacity" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="orf_crest_level" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_sewerage" configurationFlags="None">
    ...
    <field name="orf_cross_section_definition_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_friction_value" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_friction_type" configurationFlags="None">
    ...
    <field name="orf_discharge_coefficient_positive" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_discharge_coefficient_negative" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_zoom_category" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
    ...
    <field name="orf_crest_type" configurationFlags="None">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
    ...
    <field name="orf_connection_node_start_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
    ...
    <field name="orf_connection_node_end_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" name="IsMultiline" value="false"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="orf_max_capacity"/>
  ...
  <defaults>
    ...
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))) is null, 'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))))" applyOnUpdate="0" field="orf_connection_node_start_id"/>
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))) is null, 'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))))" applyOnUpdate="0" field="orf_connection_node_end_id"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_id"/>
    <constraint unique_strength="0" exp_strength="2" notnull_strength="2" constraints="5" field="orf_display_name"/>
    <constraint unique_strength="0" exp_strength="2" notnull_strength="2" constraints="5" field="orf_code"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="orf_max_capacity"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_crest_level"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="orf_sewerage"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_cross_section_definition_id"/>
    <constraint unique_strength="0" exp_strength="2" notnull_strength="2" constraints="5" field="orf_friction_value"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_friction_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_discharge_coefficient_positive"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_discharge_coefficient_negative"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_zoom_category"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_crest_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_connection_node_start_id"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="orf_connection_node_end_id"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;orf_discharge_coefficient_negative&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="orf_id" hidden="0"/>
      <column width="-1" type="field" name="orf_display_name" hidden="0"/>
      <column width="-1" type="field" name="orf_code" hidden="0"/>
      <column width="-1" type="field" name="orf_crest_level" hidden="0"/>
      <column width="-1" type="field" name="orf_sewerage" hidden="0"/>
      <column width="-1" type="field" name="orf_cross_section_definition_id" hidden="0"/>
      <column width="-1" type="field" name="orf_friction_value" hidden="0"/>
      <column width="-1" type="field" name="orf_friction_type" hidden="0"/>
      <column width="-1" type="field" name="orf_discharge_coefficient_positive" hidden="0"/>
      <column width="-1" type="field" name="orf_discharge_coefficient_negative" hidden="0"/>
      <column width="-1" type="field" name="orf_zoom_category" hidden="0"/>
      <column width="-1" type="field" name="orf_crest_type" hidden="0"/>
      <column width="-1" type="field" name="orf_connection_node_start_id" hidden="0"/>
      <column width="-1" type="field" name="orf_connection_node_end_id" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="Orifice view" visibilityExpression="" groupBox="0" showLabel="1">
