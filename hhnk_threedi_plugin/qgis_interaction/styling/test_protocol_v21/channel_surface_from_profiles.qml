...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="singleSymbol" enableorderby="0">
    <symbols>
      <symbol type="fill" name="0" alpha="0.796078" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="150,0,125,255" k="color"/>
  ...
  <fieldConfiguration>
    ...
    <field name="cnt" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="nr"/>
    <alias name="" index="3" field="cnt"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="cnt"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="nr"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="cnt"/>
