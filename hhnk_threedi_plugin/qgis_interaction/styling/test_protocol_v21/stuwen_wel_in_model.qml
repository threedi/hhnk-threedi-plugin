...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="ACTIEVARIABELE" editable="1"/>
    <field name="ACTIEWAARDEN" editable="1"/>
    ...
    <field name="DREMPEL" editable="1"/>
    <field name="HOOGSTEDOORSTROOMHOOGTE" editable="1"/>
    <field name="KRUINBREEDTE" editable="1"/>
    <field name="KeuzeRegeling" editable="1"/>
    <field name="LAAGSTEDOORSTROOMHOOGTE" editable="1"/>
    <field name="MAX_KRUINHOOGTE" editable="1"/>
    <field name="MEETVARIABELE" editable="1"/>
    <field name="MEETWAARDEN" editable="1"/>
    <field name="MIN_KRUINHOOGTE" editable="1"/>
    ...
    <field name="TYPE_KUNSTWERK" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="ACTIEWAARDEN" labelOnTop="0"/>
    ...
    <field name="DREMPEL" labelOnTop="0"/>
    <field name="HOOGSTEDOORSTROOMHOOGTE" labelOnTop="0"/>
    <field name="KRUINBREEDTE" labelOnTop="0"/>
    <field name="KeuzeRegeling" labelOnTop="0"/>
    <field name="LAAGSTEDOORSTROOMHOOGTE" labelOnTop="0"/>
    <field name="MAX_KRUINHOOGTE" labelOnTop="0"/>
    <field name="MEETVARIABELE" labelOnTop="0"/>
    <field name="MEETWAARDEN" labelOnTop="0"/>
    <field name="MIN_KRUINHOOGTE" labelOnTop="0"/>
    ...
    <field name="TYPE_KUNSTWERK" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="ACTIEWAARDEN" reuseLastValue="0"/>
    <field name="CODE" reuseLastValue="0"/>
    <field name="DOORSTROOMBREEDTE" reuseLastValue="0"/>
    <field name="DREMPEL" reuseLastValue="0"/>
    <field name="HOOGSTEDOORSTROOMHOOGTE" reuseLastValue="0"/>
    <field name="KRUINBREEDTE" reuseLastValue="0"/>
    <field name="KeuzeRegeling" reuseLastValue="0"/>
    <field name="LAAGSTEDOORSTROOMHOOGTE" reuseLastValue="0"/>
    <field name="MAX_KRUINHOOGTE" reuseLastValue="0"/>
    <field name="MEETVARIABELE" reuseLastValue="0"/>
    <field name="MEETWAARDEN" reuseLastValue="0"/>
    <field name="MIN_KRUINHOOGTE" reuseLastValue="0"/>
    ...
    <field name="TYPE_KUNSTWERK" reuseLastValue="0"/>
