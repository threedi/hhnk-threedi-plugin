...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
        ...
        <layer enabled="1" pass="0" class="MarkerLine" locked="0">
          ...
          <symbol type="marker" name="@0@0" alpha="1" clip_to_extent="1" force_rhr="0">
            <layer enabled="1" pass="0" class="SvgMarker" locked="0">
              ...
              <prop v="//srv57d1/geo_info/02_Werkplaatsen/06_HYD/Projecten/HKC16015 Wateropgave 2.0/00.Media/duiker.svg" k="name"/>
              <prop v="0,0" k="offset"/>
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
  ...
  <fieldConfiguration>
    ...
    <field name="Categorie" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="modelleren_als" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="Categorie"/>
    <alias name="" index="3" field="modelleren_als"/>
    <alias name="" index="4" field="opmerkingen"/>
    <alias name="" index="5" field="SHAPE_Length"/>
  </aliases>
  <defaults>
    <default expression="" applyOnUpdate="0" field="OBJECTID"/>
    <default expression="" applyOnUpdate="0" field="CODE"/>
    <default expression="" applyOnUpdate="0" field="Categorie"/>
    <default expression="" applyOnUpdate="0" field="modelleren_als"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="Categorie"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="modelleren_als"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="modelleren_als"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="Categorie" hidden="0"/>
      <column width="-1" type="field" name="modelleren_als" hidden="0"/>
