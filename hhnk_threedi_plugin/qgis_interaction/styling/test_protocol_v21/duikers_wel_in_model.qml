...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <fieldConfiguration>
    ...
    <field name="bed_level_upstream" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="bed_level_downstream" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="shape_culvert" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="type_art" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="fixeddrainagelevelarea_id_1" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="fixeddrainagelevelarea_id_2" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="op_peilgrens" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="op_poldergrens" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="bed_level_upstream"/>
    <alias name="" index="7" field="bed_level_downstream"/>
    <alias name="" index="8" field="width"/>
    <alias name="" index="9" field="length"/>
    <alias name="" index="10" field="allowed_flow_direction"/>
    <alias name="" index="11" field="height"/>
    <alias name="" index="12" field="material"/>
    <alias name="" index="13" field="shape_culvert"/>
    <alias name="" index="14" field="description"/>
    <alias name="" index="15" field="image_url"/>
    <alias name="" index="16" field="num_timeseries"/>
    <alias name="" index="17" field="channel_code"/>
    <alias name="" index="18" field="channel_type_id"/>
    <alias name="" index="19" field="type_art"/>
    <alias name="" index="20" field="opmerking"/>
    <alias name="" index="21" field="wgtype_id"/>
    <alias name="" index="22" field="fixeddrainagelevelarea_id_1"/>
    <alias name="" index="23" field="fixeddrainagelevelarea_id_2"/>
    <alias name="" index="24" field="op_peilgrens"/>
    <alias name="" index="25" field="op_poldergrens"/>
    <alias name="" index="26" field="opmerk_datamining"/>
    <alias name="" index="27" field="aanname"/>
    <alias name="" index="28" field="isusable"/>
    <alias name="" index="29" field="hasassumption"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="bed_level_upstream"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="bed_level_downstream"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="height"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="material"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="shape_culvert"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="type_art"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="fixeddrainagelevelarea_id_1"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="fixeddrainagelevelarea_id_2"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="op_peilgrens"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="op_poldergrens"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="bed_level_upstream"/>
    <constraint desc="" exp="" field="bed_level_downstream"/>
    ...
    <constraint desc="" exp="" field="shape_culvert"/>
    ...
    <constraint desc="" exp="" field="type_art"/>
    <constraint desc="" exp="" field="opmerking"/>
    <constraint desc="" exp="" field="wgtype_id"/>
    <constraint desc="" exp="" field="fixeddrainagelevelarea_id_1"/>
    <constraint desc="" exp="" field="fixeddrainagelevelarea_id_2"/>
    <constraint desc="" exp="" field="op_peilgrens"/>
    <constraint desc="" exp="" field="op_poldergrens"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;channel_type_id&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="bed_level_upstream" hidden="0"/>
      <column width="-1" type="field" name="bed_level_downstream" hidden="0"/>
      ...
      <column width="-1" type="field" name="shape_culvert" hidden="0"/>
      ...
      <column width="-1" type="field" name="type_art" hidden="0"/>
      <column width="-1" type="field" name="opmerking" hidden="0"/>
      <column width="-1" type="field" name="wgtype_id" hidden="0"/>
      <column width="-1" type="field" name="fixeddrainagelevelarea_id_1" hidden="0"/>
      <column width="-1" type="field" name="fixeddrainagelevelarea_id_2" hidden="0"/>
      <column width="-1" type="field" name="op_peilgrens" hidden="0"/>
      <column width="-1" type="field" name="op_poldergrens" hidden="0"/>
