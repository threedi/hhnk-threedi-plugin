...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>v2_levee</se:Name>
    <UserStyle>
      <se:Name>v2_levee</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>1: sand</se:Name>
          <se:Description>
            <se:Title>1: sand</se:Title>
          </se:Description>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#aa5b52</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>2: clay</se:Name>
          <se:Description>
            <se:Title>2: clay</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>material</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>NULL or other</se:Name>
          <se:Description>
            <se:Title>NULL or other</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
