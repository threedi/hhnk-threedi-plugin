...
<qgis readOnly="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.16.11-Hannover" maxScale="0">
  ...
  <aliases>
    ...
    <alias name="" index="1" field="impervious_surface_id"/>
    <alias name="" index="2" field="connection_node_id"/>
    <alias name="" index="3" field="percentage"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="impervious_surface_id"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="impervious_surface_id"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="impervious_surface_id" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="General" visibilityExpression="" groupBox="0" showLabel="1">
      ...
      <attributeEditorField name="impervious_surface_id" showLabel="1" index="1"/>
  ...
  <editable>
    ...
    <field name="impervious_surface_id" editable="1"/>
    <field name="percentage" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="connection_node_id" labelOnTop="0"/>
    <field name="id" labelOnTop="0"/>
    <field name="impervious_surface_id" labelOnTop="0"/>
