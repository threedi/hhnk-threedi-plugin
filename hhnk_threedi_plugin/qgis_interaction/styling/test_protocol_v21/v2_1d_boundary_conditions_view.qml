...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="-4.65661e-10" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <aliases>
    ...
    <alias name="" index="2" field="connection_node_id"/>
    <alias name="" index="3" field="boundary_type"/>
    <alias name="" index="4" field="timeseries"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="id"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="connection_node_id"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="boundary_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="timeseries"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="ROWID"/>
    <constraint desc="" exp="" field="id"/>
    <constraint desc="" exp="" field="connection_node_id"/>
    <constraint desc="" exp="" field="boundary_type"/>
    <constraint desc="" exp="" field="timeseries"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="boundary_type" hidden="0"/>
      <column width="-1" type="field" name="timeseries" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="General" visibilityExpression="" groupBox="0" showLabel="1">
      ...
      <attributeEditorField name="connection_node_id" showLabel="1" index="2"/>
      <attributeEditorField name="boundary_type" showLabel="1" index="3"/>
      <attributeEditorField name="timeseries" showLabel="1" index="4"/>
