...
<qgis maxScale="0" simplifyMaxScale="1" version="3.16.11-Hannover" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyLocal="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" isExpression="1" fontStrikeout="0" fontSize="8.25" textOrientation="horizontal" fontSizeUnit="Point" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" namedStyle="Standaard" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="0,0,0,255" allowHtml="0" capitalization="0" fontItalic="0" blendMode="0" fontWeight="50" textOpacity="1" useSubstitutions="0" fieldName="round(cw_tot/1000000,2)" fontUnderline="0" fontKerning="1" fontFamily="MS Shell Dlg 2" fontWordSpacing="0">
        <text-buffer bufferBlendMode="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferDraw="1" bufferOpacity="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferNoFill="0"/>
      ...
      <text-format addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" reverseDirectionSymbol="0" plussign="0" decimals="3" wrapChar="" multilineAlign="4294967295" autoWrapLength="0" placeDirectionSymbol="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1"/>
      <placement xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" layerType="UnknownGeometry" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistance="0" geometryGeneratorType="PointGeometry" distUnits="MM" rotationAngle="0" repeatDistanceUnits="MM" geometryGenerator="" dist="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" centroidInside="1" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" geometryGeneratorEnabled="0" offsetUnits="MapUnit" polygonPlacementFlags="2" placement="1" lineAnchorPercent="0.5" offsetType="0" repeatDistance="0" yOffset="0" quadOffset="4"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="peil_id" width="-1" hidden="0"/>
      <column type="field" name="code" width="-1" hidden="0"/>
      <column type="field" name="name" width="-1" hidden="0"/>
      <column type="field" name="cw_ws" width="-1" hidden="0"/>
      <column type="field" name="cw_mv" width="-1" hidden="0"/>
      <column type="field" name="cw_tot" width="-1" hidden="0"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:/Users/chris.kerklaan/Documents/Github/hhnk-threedi-tools/hhnk_threedi_tools/qgis</editform>
  <editforminit/>
  <editforminitcodesource>0</editforminitcodesource>
  <editforminitfilepath>C:/Users/chris.kerklaan/Documents/Github/hhnk-threedi-tools/hhnk_threedi_tools/qgis</editforminitfilepath>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="cw_mv"/>
    <field editable="1" name="cw_tot"/>
    <field editable="1" name="cw_ws"/>
    <field editable="1" name="id"/>
    <field editable="1" name="name"/>
    <field editable="1" name="over3sum"/>
    <field editable="1" name="overlast_s"/>
    <field editable="1" name="peil_id"/>
    <field editable="1" name="plas2sum"/>
    <field editable="1" name="plas3sum"/>
    <field editable="1" name="tot_dmg"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="code"/>
    <field labelOnTop="0" name="cw_mv"/>
    <field labelOnTop="0" name="cw_tot"/>
    <field labelOnTop="0" name="cw_ws"/>
    <field labelOnTop="0" name="id"/>
    <field labelOnTop="0" name="name"/>
    <field labelOnTop="0" name="over3sum"/>
    <field labelOnTop="0" name="overlast_s"/>
    <field labelOnTop="0" name="peil_id"/>
    <field labelOnTop="0" name="plas2sum"/>
    <field labelOnTop="0" name="plas3sum"/>
    <field labelOnTop="0" name="tot_dmg"/>
  </labelOnTop>
