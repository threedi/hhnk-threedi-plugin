...
# Form implementation generated from reading ui file 'e:\github\wvangerwen\hhnk-threedi-plugin\hhnk_threedi_plugin\hhnk_toolbox_dockwidget_base2.ui'
#
...
class Ui_HHNK_toolboxDockWidget(object):
    def setupUi(self, HHNK_toolboxDockWidget):
        ...
        self.create_new_project_btn = QtWidgets.QPushButton(self.tab)
    ...
    def retranslateUi(self, HHNK_toolboxDockWidget):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("HHNK_toolboxDockWidget", "Tab 1"))
