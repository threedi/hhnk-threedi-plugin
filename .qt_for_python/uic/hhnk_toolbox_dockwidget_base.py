...
class Ui_HHNK_toolboxDockWidget(object):
    def setupUi(self, HHNK_toolboxDockWidget):
        ...
        HHNK_toolboxDockWidget.resize(305, 523)
        ...
        HHNK_toolboxDockWidget.setMinimumSize(QtCore.QSize(215, 400))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.server_btn.sizePolicy().hasHeightForWidth())
        self.server_btn.setSizePolicy(sizePolicy)
        ...
        self.sqlite_tests.setGeometry(QtCore.QRect(0, 0, 257, 257))
